...
class Norway {
    ...
    specifications  = {
        displacement_mt: 622e3,
        overall_length_m: 365,
        overall_draft_m: 53,
        overall_beam_m: 226
    }
    ...
    computers = [
        {
            type: ['M-14 Isolinear III '], // with LCARS   Isolinear III with LCARS  M-16 Bio-Neutral Gel Pack - isolinear III with LCARS
