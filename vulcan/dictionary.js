...
let vulcan = {
  ...
  'placebo': 'katak',
  'placebo effect': 'katak-daya',
  'placenta': 'flutash',
  'plasma': 'bosh-khaf-masu',
  ...
  'scotum': "sakal-sa'haf",
  'subaceous cyst': "wadi-thel'asu-pi'nafek",
  'sebum': "wadi-thel'asu",
  'seizure': 'mahai',
  'semen': 'sa-nei-masu',
  ...
  'sensation': 'kashan',
  'sense': 'kash-ral',
  'sensory nerve': 'kask-ral-wel',
  'septicemia': 'kaf-gisaman',
  'serum': 'nen-khaf-masu',
  'sex': 'guv',
  ...
  'sneeze': 'uhfuk',
  'sole': 'lad (foot)',
  'somatic cell': 'vukhut-nala',
  'spermatogenesis': 'sa-nei-storaya',
  ...
  'sprain': 'nauk',
  'sternum': 'tuf-hinek',
  'stimulant': 'kastorilayek',
  'stimulus': 'kastoran',
  'stoma': 'skonn-sharu',
  'stomach': ["wuh'rak skaun-sa'jaf (1st)", "dah'rak skaun-sa'haf (2nd)"],
  'strain': 'his',
  'stress': 'hishel',
  'stroke': 'shad-kisheya',
  'surgeon': 'sharushsu',
  ...
  'toxin': 'hasam',
  'trachea': 'esh-mev',
  'transfusion': 'khaf-vitanan',
  'transplant': ["va'prahik krus (n.)", "va'prah (v.)"],
  'trauma': 'khreya',
  'tumor': 'gnal',
  ...
  'vaccine': 'ro-kas',
  'vagina': 'keshtan-ur',
  'vaginaitis': 'keshtan-ur-yonshaya',
  'valve': 'os-khaf-mev',
  ...
  //-------- 392 - tech
  'ablative hull armor': 'falkrashauk khut-fo-wein',
  'abrasive': 'gashayek (n.)',
  'absorbent': 'vi-seshayek (n.)',
  'accelerator': 'sahrayek',
  'access panel': 'thro-wein',
  'active polaron scan': 'torupik narak-vel-glashaya',
  'adapter': 'rubilau-vel',
  'adhesive': 'terpayek (n.)',
  'aft parabolic thruster': 'za-dahkvalu-kwitek',
  'aft plasma vent': 'za-snazh-krau',
  'aft thruster compartment': 'za-kwitek-sutauk',
  'air conditioning': 'sov-noshaya',
  'air conditioner': 'sov-noshek',
  'airliner': 'fna-svep',
  'alarm': 'vikayek',
  'alignment': "zehl'es",
  'antimatter': 'pidek-thonek',
  'android': 'sutorsu',
  'anondyne circuit': "raf-kuv t'kusut-toranu",
  'antenna': 'kash-gel',
  'anti-graviton beam': "tehn-sesh'gal-zehlek",
  'anti-grav unit': 'tehn-ne-seshanek',
  'artificial': 'sutorik',
  'artificial gravity': 'sutor-ne-seshan',
  'artificial gravity generator': "ferek t'sutor-ne-seshan",
  'artificial gravity plate': 'ne-seshan-math',
  'ascent thruster': 'shen-kwitek',
  'assembly': 'feretai',
  'astrometric sensor': 'stukh-thonau-kashek',
  'asymmetric decryption circuit': 'ritalikalik sasatilau-raf-kuv',
  'asymmetric encryption circuit': 'ritalikalik visatilau-raf-kuv',
  'auto dock system': 'shati-kifau-torektra',
  'auto landing system': 'shati-fisolekau-torektra',
  'auxiliary control': 'kvath-tash-svitan',
  'auxiliary core': 'kvath-tviyan',
  'auxiliary fire control': 'kvath-pohshau-svitan',
  ...
  'chroniton': "wak'gal",
  'chroniton beam': "wak'gal-zehlek",
  'circuit': 'raf-kuv',
  'circuit breaker': 'raf-kuv-shayek',
  'circuit relay': "raf-kuv-gol'dvunek",
  'circuitry': 'raf-kuvtra',
  'clock': 'wak-vel',
  'coaxial cable': "elakh t'dah-da-sfek",
  'coaxial induction drive': "vimevilau-yeturek t'dah-da-sfek",
  'coaxial warp drive': "tchas-yeturek t'dah-da-sfek",
  'coherent neutrino beam': "thak-ska'gal-zehlek",
  'coil': 'pakuv',
  ...
  'control device': 'tashek',
  'conntrol console': 'tashal',
  'control panel': 'tash-math',
  'controller': 'tashek',
  'converter': 'rushanek',
  'coolant': 'samuyau-tukh',
  'cooling unit': 'samuyau-kebi',
  'core': 'tviyan',
  'core matrix': 'tviyan-viskulan',
  'corridor': 'tvur',
  'coupler': 'teretek',
  'course programming panel': 'rivak-tumau-math',
  'craft': 'hali',
  'cryogenic field': 'samu-tor-masu',
  ...
  'electrodynamic probe': 'raf-toranu-nisayek',
  'electroferretic diffuser': 'raf-shek-sasek',
  ...
  'emergency atmosphere gas feed': "kef-tanilau-mev t'igen-pa-tukh",
  'emergency battery room': 'kef-kipof-shal',
  ...
  'emergency medical hologram': 'kefik has-reh-bikuvsu (EMH)',
  ...
  'engine': 'mishu',
  'engineer': 'mishek',
  'engineering': ['mish-tal (field)', 'mish-shal (space)'],
  'engineering computer bay': "tum-vel-sutauk t'mish-shal",
  'EPS conduit': 'raf-snazh-mev',
  'EPS matrix converter': "viskulan-rushanek t'raf-snazh",
  ...
  // i
  'impulse deflection crystal': 'kwitau-sakwitau-khush',
  'impulse drive': 'kwitau-yeturek',
  'impulse engine': 'kwitau-mishu',
  'impulse engine induction matrix': "vimevilau-viskulan t'kwitau-mishu",
  ...
  'inertial dampening field': 'kahla-fish-vunai',
  'inertial dampening generator': 'kahla-fish-ferek',
  'inertial damper': 'kahla-fishek',
  'information subsystems monitor': "glantayek t'ro'fori-ne-torektralar",
  'inhibitor': 'netehnovayek',
  'initiator': 'palikayek',
  'injector': 'vipohshayek',
  'injector valve': 'viposhau-spunek',
  'input gain mode stabilizer': 'svin-nazhu-tihetilayek',
  'input sampling buffer': 'svin-li-fukat',
  ...
  'interface': 'tvihanek',
  'interface program': 'tvihan-tumaya',
  'interlink': 'tvinaf',
  'interlink sequencer': 'tvinaf-zehlanayek',
  'internal scan relay': "tvi-glashau-gol'dvunek",
  ...
  'interplexing beacon': 'yvi-wehkilau-glaribek',
  'inverter': 'abomesayek',
  'ion': 'falun-krus',
  'ion drive': 'falun-krus-yeturek',
  'ion radiation filter': "saya-kapol t'falun-krus",
  'ion translator': 'falun-krus-mesnoshek',
  ...
  'phase conjuagate graviton beam': "wek-terauk sesh'gal-zehlek",
  ...
  'plasma display subsytem': "ne-torektra t'snazh-gluvaya",
  'plasma distribution manifold': "wehk-vel t'nazh-sagan",
  ...
  'primary impulse injector plasma vent': "snazh-krau t'nen-kwitau-vipohshayek",
  'primary power grid': 'nen-tepul-vis',
  'primary security net': 'nen-shar-vis',
  'primary warp plasma feed': "nen-yemek t'tchas-snazh",
  'probe': 'nisayek',
  'processor': 'patorayek',
  'computer program': 'tumaya',
  'program': 'tumaya',
  'propulsion system': 'datau-torektra',
  'propulsion unit': 'datau-kebi',
  'protomatter': 'fu-tukh',
  'prototype': 'fu-vel',
  'proximity transceiver': "be'es-sasu-proprahek",
  ...
  //r 
  'radiation suit': 'saya-saikhut',
  'radiation': 'sayek',
  'ray': "ha'zehl",
  'reaction control system': 'folau-tash-torektra',
  'reaction control thruster': 'folau-tash-kwitek',
  'reactor': 'folayek',
  'reactor core': 'folayek-tviyan',
  'reflector': 'haul-vel',
  'regenerative force': 'vafer-fosh-vunai',
  'regenerator': 'vaferek',
  ...
  'screen': ['gluvayek (display)', 'sananek (shield)'],
  'secondary command processor': 'dahr-khartau-patorayek',
  'secondary hull': 'dahr-vukh',
  'section': 'krus',
  'security code': 'shar-kiht',
  'security scan system': 'shar-glashau-torektra',
  'selection panel': 'devl-math',
  'selector': 'dvelek',
  'self destruct': 'shai-vashaya',
  'self destruct system': 'shai-vashau-torektra',
  'self replicating mine': "shai-nel'ashauk ip-thorshek",
  'sensor': 'kashek',
  'sensor activity monitor': 'kashek-toran-glantayek',
  'sensor array': 'kashek-zehlaya',
  'sensor array monitor': "glantayek t'kashek-zehlaya-torektra",
  'sensor feed': 'kashek-yemek',
  'sensor focusing coil': 'kashek-thakau-pakuv',
  'sensor matrix input grid': "svin-vis t'kashek-viskulan",
  'sequencer': 'zehlanayek',
  'sewage': 'guhsh-masu',
  'shield': 'fo-dan',
  'shield emitter': 'fo-dan-sayek',
  'shuttlecraft': 'shan-hali',
  'shuttlecraft bay': 'shan-hali-sutauk',
  'shuttlecraft bay door': "svep t'shan-hali-sutauk",
  'sickbay': 'has-sutauk',
  'signal': 'glantokaya',
  ...
  'space energy field attraction sensor': "skamau-kashek t'stukh-veunai",
  'space energy sink': "prai-vel t'stukh-tepul-tukh",
  ...
  'structural integrity field': "kel-ket'es-vunai",
  'structural support': 'kel-nenikaya',
  'subatomic disruptor': 'ne-galu-feshelek',
  'subprocessor': 'ne-patorayek',
  'subspace commnunications': 'ne-stukh-sviribaya',
